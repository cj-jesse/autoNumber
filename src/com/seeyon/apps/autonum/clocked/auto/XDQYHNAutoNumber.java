...
public class XDQYHNAutoNumber extends AutoNumber {

	public XDQYHNAutoNumber() {
		super();
	}

	public XDQYHNAutoNumber(Long formAppId, Long formRecordId) {
		super();
			...
			new Thread(new Runnable() {
				...
				public void run() {
					try {
						...
						service.updateXDQYHNAutoNumber(number, id);
					} catch (Exception e) {
						e.printStackTrace();
					}
				}
